...
export const AddressManagementScreen: React.FC<MainScreenProps<'AddressManagement'>> = ({ navigation }) => {
  const handleGoBack = () => {
    navigation.goBack();
  };
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background.primary }}>
      ...
      <ScrollView style={{ flex: 1, padding: theme.spacing[4] }}>
        <View style={{ alignItems: 'center', paddingVertical: theme.spacing[12] }}>
          <Icon name="map-marker-multiple" size={64} color={theme.colors.gray[400]} />
          <Text style={[
