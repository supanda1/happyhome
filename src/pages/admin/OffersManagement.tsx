            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-1 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2">
              <div className="relative overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-xl p-6 text-center">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl font-bold text-white mb-2 animate-pulse">{Array.isArray(offers) ? offers.length : 0}</p>
                  <p className="text-xs text-blue-200">Plans Available</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-1 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2">
              <div className="relative overflow-hidden bg-gradient-to-br from-green-500 via-green-600 to-emerald-600 rounded-xl p-6 text-center">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl font-bold text-white mb-2 animate-pulse">{Array.isArray(offers) ? offers.filter(o => o.is_active).length : 0}</p>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-1 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2">
              <div className="relative overflow-hidden bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-600 rounded-xl p-6 text-center">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl font-bold text-white mb-2 animate-pulse">
                    {Array.isArray(offers) && offers.length > 0 ? Math.round(offers.reduce((sum, o) => sum + o.discount_percentage, 0) / offers.length) : 0}%
                  </p>
                  <p className="text-xs text-purple-200">Customer Savings</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-1 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2">
              <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 rounded-xl p-6 text-center">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl font-bold text-white mb-2 animate-pulse">{Array.isArray(offers) && offers.length > 0 ? Math.max(...offers.map(o => o.duration_months), 0) : 0}M</p>
                  <p className="text-xs text-orange-200">Months</p>
                </div>
              </div>
            </div>
